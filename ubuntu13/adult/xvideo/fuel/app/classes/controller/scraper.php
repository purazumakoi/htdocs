...
class Controller_Scraper extends \Controller_Template {
...
//		}
	...
	*/
	public function action_index()
	{
		...
		\Response::redirect('scraper/entry');
...
//print "raaa ";exit;
	...
	public function action_list()
	{
		...
		foreach($contact_ary as $key => $val){
			$contact_ary[$key]['body'] = unserialize($val['body']);
		}

		$this->template->title = 'Contact &raquo; Step3';

		$view = \View::forge('contact/list');
		$view->set('data', $contact_ary);
		$view->set('name', 'aaaet');
