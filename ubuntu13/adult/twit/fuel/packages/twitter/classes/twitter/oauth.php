...
class Twitter_Oauth {
    ...
    /**
     * Gets the Access verifier from the Session.
     *
     * @return  string|null  The Access Verifier
     */
    ...
    /**
     * Sets the access_verifier key in the session
     *
     * @param   string  $access_verifier  The access verifier
     * @return  $this
     */
    public function set_access_verifier($access_verifier)
    {
        $tokens = \Session::get('twitter_oauthtokens');
    ...
    protected function prep_params($method = null, $url = null, $params = null)
    {
        ...
        $oauth['oauth_verifier']          = $this->get_access_verifier();
