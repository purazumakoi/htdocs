...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] = 
        array(
            ...
            'text'          =>array('HTML/QuickForm/text.php','HTML_QuickForm_text'),
						'tel'           =>array('HTML/QuickForm/tel.php','HTML_QuickForm_tel'),
...
class HTML_QuickForm extends HTML_Common {
    ...
    //function setDefaults($defaultValues = null, $filter = 'fEncToSJIS')		// G@net
    //function setDefaults($defaultValues = null, $filter = 'fEncToSJISAddSlash')		// G@net
    {
